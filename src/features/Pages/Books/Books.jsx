      ...
      <div className="w-[80%] flex flex-col py-[20px] px-[20px] ">
        <div className="w-full h-full flex  justify-center gap-[30px] flex-wrap">  
          {books?.map((item, index) => {
            return (
              <div key={index} class="flex flex-col rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 w-[270px] transform  rounded-xl h-[450px]  sm:h-300px sm:w-300px bg-white shadow-xl transition duration-300 hover:scale-105">
                ...
                <h6 className="bg-[#e67300] text-center text-white font-[400] text-[13px]  tracking-widest	 leading-[20px] uppercase rounded-[10px] w-[100px]">Code: {item.code}</h6>
                <h6 className="bg-[#00b33c] text-center text-white font-[400] text-[13px]  tracking-widest	 leading-[20px] uppercase rounded-[10px] w-[150px]">Author ID: {item.author_id}</h6>
                </div>
                <h1 className="text-[22px] font-[600] font-bold three relative"><span className="px-1">Name: {item.name}</span></h1>
